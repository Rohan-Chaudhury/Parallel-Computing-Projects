...
void HyperCube_Class::check_list() {
    int tag = 0;
    int max_nbr = 2147483647;		// Assumes list contains non-negative integers; 6-21-2017
...
void HyperCube_Class::HyperCube_QuickSort() {
	...
	// ***** Add MPI call here *****
	int median_global;
	MPI_Allreduce(&local_median, &median_global, 1, MPI_INT, MPI_SUM, sub_hypercube_comm);					
	pivot = median_global/sub_hypercube_size;
